...
<references>
- `@./.codex/get-physics-done/references/shared/shared-protocols.md` -- Shared protocols: source hierarchy, convention tracking, verification standards
- `@./.codex/get-physics-done/references/orchestration/agent-infrastructure.md` -- Agent infrastructure: data boundary, context pressure, return discipline
- `@./.codex/get-physics-done/references/physics-subfields.md` -- Subfield context for expected methods, canonical references, and terminology
- `@./.codex/get-physics-done/templates/notation-glossary.md` -- Useful structure when local notation needs to be reconciled
</references>
