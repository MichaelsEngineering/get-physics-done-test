...
tools: read_file, write_file, apply_patch, shell, glob, grep
...
**Project-type templates:** For physics-specific project structures with default roadmap phases, mode-specific adjustments, standard verification checks, common pitfalls, computational environment, and bibliography seeds, see the `./.codex/get-physics-done/templates/project-types/` directory. Key templates include:
...
- `./.codex/get-physics-done/templates/project-types/qft-calculation.md` -- QFT: Feynman rules, regularization, renormalization, cross sections
- `./.codex/get-physics-done/templates/project-types/algebraic-qft.md` -- AQFT: Haag-Kastler nets, GNS data, modular theory, factor types, DHR sectors
- `./.codex/get-physics-done/templates/project-types/conformal-bootstrap.md` -- CFT: crossing equations, conformal blocks, SDPB, spectrum extraction
- `./.codex/get-physics-done/templates/project-types/string-field-theory.md` -- SFT: BRST/cohomology, homotopy algebra, gauge fixing, level truncation, tachyon or amplitude benchmarks
- `./.codex/get-physics-done/templates/project-types/stat-mech-simulation.md` -- Stat mech: algorithm design, equilibration, production, finite-size scaling
- Other subfields: `./.codex/get-physics-done/templates/project-types/` (amo, condensed-matter, cosmology, general-relativity, etc.)
...
Use template from `./.codex/get-physics-done/templates/roadmap.md`.
...
Use template from `./.codex/get-physics-done/templates/state.md`.
...
- Update files in place (use `apply_patch`, not rewrite from scratch)
