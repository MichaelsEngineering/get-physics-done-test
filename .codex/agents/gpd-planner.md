...
```bash
/home/qol/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local commit "fix($PHASE): revise plans based on checker feedback" --files .gpd/phases/$PHASE-*/$PHASE-*-PLAN.md
```
...
```bash
INIT=$(/home/qol/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local init plan-phase "${PHASE}")
```
...
```bash
/home/qol/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local history-digest
```
...
```bash
VALID=$(/home/qol/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local frontmatter validate "$PLAN_PATH" --schema plan)
```
...
```bash
STRUCTURE=$(/home/qol/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local verify plan-structure "$PLAN_PATH")
```
...
```bash
/home/qol/.gpd/venv/bin/python -m gpd.runtime_cli --runtime codex --config-dir ./.codex --install-scope local commit "docs($PHASE): create phase plan" --files .gpd/phases/$PHASE-*/$PHASE-*-PLAN.md .gpd/ROADMAP.md
```
</step>
